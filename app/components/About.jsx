    ...
    return (
        <div className="mt-32">
            <div className="h-screen w-screen relative overflow-hidden flex items-center" data-aos="fade-up">
                ...
                {/* Text Content */}
                <div className="absolute left-10 top-[65%] transform -translate-y-1/2 w-full font-sans font-light text-white">
                    <h1 className="text-7xl leading-tight mb-5">{info.title}</h1>
                    <p className="text-2xl leading-loose font-thin mb-5">{info.subtitle}</p>
                    <a
