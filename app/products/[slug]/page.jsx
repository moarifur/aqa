...
const ProductDetailPage = ({params}) => {
    const detailData = productData.filter(product => product.id === parseInt(params.slug))
    return (
        <div className='flex flex-col justify-between lg:flex-row gap-16 lg:items-center md:mt-16 mb-0'>
            {
                detailData.map(singleData => {
                    return (
                        <>
                            ...
                            <div className='flex flex-col gap-4 lg:w-2/4'>
                                <div>
                                    <h1 className='text-3xl font-bold'>{singleData.title}</h1>
                                </div>
